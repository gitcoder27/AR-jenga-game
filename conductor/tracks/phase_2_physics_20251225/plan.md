...
- [ ] Task: Create Jenga Block Component
    - [ ] Sub-task: Write Tests: Verify block dimensions and physics properties (mass, friction, restitution)
    - [ ] Sub-task: Implement `Block` component using `RigidBody` and `Box`
- [ ] Task: Implement Tower Generation Algorithm
    - [ ] Sub-task: Write Tests: Verify algorithm generates 54 blocks with correct alternating rotations and jitter
    - [ ] Sub-task: Implement `Tower` component to generate the stack
